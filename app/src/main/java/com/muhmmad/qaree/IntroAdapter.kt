...
import com.muhmmad.qaree.databinding.IntroLayoutBinding

class IntroAdapter : RecyclerView.Adapter<IntroAdapter.ViewHolder>() {
    class ViewHolder(val binding: IntroLayoutBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            IntroLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
