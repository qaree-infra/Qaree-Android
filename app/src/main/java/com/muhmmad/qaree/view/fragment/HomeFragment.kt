...
import com.muhmmad.qaree.view.adapters.AuthorsAdapter
import com.muhmmad.qaree.view.adapters.BooksAdapter
import com.muhmmad.qaree.view.adapters.CategoriesAdapter
import com.muhmmad.qaree.view.adapters.OffersAdapter
import com.muhmmad.qaree.viewModel.HomeViewModel
...
//                            binding.tvReadingPages.text = "$readingProgress/100"
                            ...
                            binding.tvProgressPresent.text = getString(
                                ...
                                String.format(Locale.getDefault(), "%.1f", readingProgress)
                            )
