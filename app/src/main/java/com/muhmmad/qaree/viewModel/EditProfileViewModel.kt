...
class EditProfileViewModel @Inject constructor(
    ...
    fun setUpdateAvatarType(type: UpdateImagesType) = viewModelScope.launch {
        _state.update {
            it.copy(
    ...
    fun updateUserName(text: String) = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun updateUserBio(text: String) = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun uploadUserAvatar(body: MultipartBody.Part) = viewModelScope.launch(Dispatchers.IO) {
