...
class HomeViewModel @Inject constructor(
    ...
    fun getLastActivity() = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun getTopAuthors() = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun getNewReleaseBooks() = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun getBestSellerBooks() = viewModelScope.launch(Dispatchers.IO) {
