...
class VerificationViewModel @Inject constructor(private val useCase: AuthUseCase) :
    ...
    fun verifyAccount(email: String, otp: String) = viewModelScope.launch(Dispatchers.IO) {
        _state.update {
            it.copy(
    ...
    fun resendVerifyOTP(email: String) = viewModelScope.launch(Dispatchers.IO) {
        _state.update {
            it.copy(
                resendVerifyResponse = null,
                verificationResponse = null,
    ...
    fun validateOTPPassword(email: String, otp: String) = viewModelScope.launch(Dispatchers.IO) {
        _state.update {
            it.copy(
                resendVerifyResponse = null,
                verificationResponse = null,
    ...
    fun resendOTPPassword(email: String) = viewModelScope.launch(Dispatchers.IO) {
        _state.update {
            it.copy(
                resendVerifyResponse = null,
                verificationResponse = null,
